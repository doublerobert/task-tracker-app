...
## GetMyTasks
You can execute the `GetMyTasks` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [database/index.d.ts](./index.d.ts):
```typescript
getMyTasks(vars: GetMyTasksVariables, options?: ExecuteQueryOptions): QueryPromise<GetMyTasksData, GetMyTasksVariables>;
...
```typescript
getMyTasks(dc: DataConnect, vars: GetMyTasksVariables, options?: ExecuteQueryOptions): QueryPromise<GetMyTasksData, GetMyTasksVariables>;
...
### Variables
The `GetMyTasks` query requires an argument of type `GetMyTasksVariables`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `GetMyTasksData`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
// Variables can be defined inline as well.
const ref = getMyTasksRef({ userId: ..., });
...
## GetAllTasks
You can execute the `GetAllTasks` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [database/index.d.ts](./index.d.ts):
```typescript
getAllTasks(options?: ExecuteQueryOptions): QueryPromise<GetAllTasksData, undefined>;
...
You can also pass in a `DataConnect` instance to the action shortcut function or `QueryRef` function.
```typescript
getAllTasks(dc: DataConnect, options?: ExecuteQueryOptions): QueryPromise<GetAllTasksData, undefined>;
...
If you need the name of the operation without creating a ref, you can retrieve the operation name by calling the `operationName` property on the getAllTasksRef:
```typescript
const name = getAllTasksRef.operationName;
console.log(name);
```

### Variables
The `GetAllTasks` query has no variables.
### Return Type
Recall that executing the `GetAllTasks` query returns a `QueryPromise` that resolves to an object with a `data` property.

The `data` property is an object of type `GetAllTasksData`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
```
### Using `GetAllTasks`'s action shortcut function

```typescript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, getAllTasks } from '@dataconnect/generated';


// Call the `getAllTasks()` function to execute the query.
// You can use the `await` keyword to wait for the promise to resolve.
...
### Using `GetAllTasks`'s `QueryRef` function

```typescript
import { getDataConnect, executeQuery } from 'firebase/data-connect';
import { connectorConfig, getAllTasksRef } from '@dataconnect/generated';


// Call the `getAllTasksRef()` function to get a reference to the query.
const ref = getAllTasksRef();

// You can also pass in a `DataConnect` instance to the `QueryRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = getAllTasksRef(dataConnect);
...
## GetTaskById
You can execute the `GetTaskById` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [database/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `GetTaskById` query requires an argument of type `GetTaskByIdVariables`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `GetTaskByIdData`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## GetAllUsers
You can execute the `GetAllUsers` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [database/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetAllUsersData`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
You can execute the `GetCurrentUserProfile` query using the following action shortcut function, or by calling `executeQuery()` after calling the following `QueryRef` function, both of which are defined in [database/index.d.ts](./index.d.ts):
```typescript
...
The `data` property is an object of type `GetCurrentUserProfileData`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## CreateUserProfile
You can execute the `CreateUserProfile` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [database/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `CreateUserProfile` mutation requires an argument of type `CreateUserProfileVariables`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `CreateUserProfileData`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## CreateTask
You can execute the `CreateTask` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [database/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `CreateTask` mutation requires an argument of type `CreateTaskVariables`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `CreateTaskData`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
// Variables can be defined inline as well.
const { data } = await createTask({ title: ..., description: ..., priority: ..., dueDate: ..., assignedToId: ..., });
...
// Variables can be defined inline as well.
const ref = createTaskRef({ title: ..., description: ..., priority: ..., dueDate: ..., assignedToId: ..., });
...
## UpdateTaskStatus
You can execute the `UpdateTaskStatus` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [database/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `UpdateTaskStatus` mutation requires an argument of type `UpdateTaskStatusVariables`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `UpdateTaskStatusData`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## UpdateTask
You can execute the `UpdateTask` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [database/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `UpdateTask` mutation requires an argument of type `UpdateTaskVariables`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `UpdateTaskData`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
// Variables can be defined inline as well.
const { data } = await updateTask({ id: ..., title: ..., description: ..., priority: ..., dueDate: ..., assignedToId: ..., });
...
// Variables can be defined inline as well.
const ref = updateTaskRef({ id: ..., title: ..., description: ..., priority: ..., dueDate: ..., assignedToId: ..., });
...
## DeleteTask
You can execute the `DeleteTask` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [database/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `DeleteTask` mutation requires an argument of type `DeleteTaskVariables`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `DeleteTaskData`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
```typescript
...
## UpdateUserRole
You can execute the `UpdateUserRole` mutation using the following action shortcut function, or by calling `executeMutation()` after calling the following `MutationRef` function, both of which are defined in [database/index.d.ts](./index.d.ts):
```typescript
...
### Variables
The `UpdateUserRole` mutation requires an argument of type `UpdateUserRoleVariables`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
...
The `data` property is an object of type `UpdateUserRoleData`, which is defined in [database/index.d.ts](./index.d.ts). It has the following fields:
```typescript

...
export const getMyTasksRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
export function getMyTasks(dcOrVars, varsOrOptions, options) {
...
export const getAllTasksRef = (dc) => {
...
export function getAllTasks(dcOrOptions, options) {
